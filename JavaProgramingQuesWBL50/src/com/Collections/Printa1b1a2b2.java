...
/*Write a program which takes an input series as a1,a2,a3....an,b1,b2,b3...bn and produces 
 output as a1,b1,a2,b2,a3,b3.......,an,bn
 * 
 * 
 */
public class Printa1b1a2b2 implements Comparator<String> {
	@Override
	...
	public static void main(String[] args) {
		...
		Collections.sort(inlist, new Printa1b1a2b2());
